...
class CalculadoraParser ( Parser ):
    ...
    class ArchivoContext(ParserRuleContext):
        ...
        def INICIOPROGRAMA(self):
            return self.getToken(CalculadoraParser.INICIOPROGRAMA, 0)

        def FINPROGRAMA(self):
            return self.getToken(CalculadoraParser.FINPROGRAMA, 0)
        ...
        def importStatement(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(CalculadoraParser.ImportStatementContext)
            else:
                return self.getTypedRuleContext(CalculadoraParser.ImportStatementContext,i)
    ...
    def archivo(self):
        ...
        try:
            ...
            self.state = 46
            self.match(CalculadoraParser.INICIOPROGRAMA)
            self.state = 50
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            ...
            self.state = 53
            self.match(CalculadoraParser.FINPROGRAMA)
            self.state = 54
    ...
    class ImportStatementContext(ParserRuleContext):
        ...
        def IMPORT(self):
            return self.getToken(CalculadoraParser.IMPORT, 0)

        def ID(self):
            return self.getToken(CalculadoraParser.ID, 0)

        def getRuleIndex(self):
            return CalculadoraParser.RULE_importStatement
    ...
    def importStatement(self):
        ...
        localctx = CalculadoraParser.ImportStatementContext(self, self._ctx, self.state)
        self.enterRule(localctx, 2, self.RULE_importStatement)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 56
            self.match(CalculadoraParser.IMPORT)
            self.state = 57
    ...
    class InstruccionSwitchContext(InstruccionContext):
        ...
        def switchStatement(self):
            return self.getTypedRuleContext(CalculadoraParser.SwitchStatementContext,0)
    ...
    class InstruccionForContext(InstruccionContext):
        ...
        def forStatement(self):
            return self.getTypedRuleContext(CalculadoraParser.ForStatementContext,0)
    ...
    class EjecutarPrintContext(InstruccionContext):
        ...
        def PRINTI(self):
            return self.getToken(CalculadoraParser.PRINTI, 0)
        def PARENTESISI(self):
            return self.getToken(CalculadoraParser.PARENTESISI, 0)
        def expresion(self):
            return self.getTypedRuleContext(CalculadoraParser.ExpresionContext,0)

        def PARENTESISD(self):
            return self.getToken(CalculadoraParser.PARENTESISD, 0)
    ...
    class InstruccionWhileContext(InstruccionContext):
        ...
        def whileStatement(self):
            return self.getTypedRuleContext(CalculadoraParser.WhileStatementContext,0)
    ...
    class InstruccionReturnContext(InstruccionContext):
        ...
        def returnStmt(self):
            return self.getTypedRuleContext(CalculadoraParser.ReturnStmtContext,0)
    ...
    class ContinueStmtContext(InstruccionContext):
        ...
        def CONTINUE(self):
            return self.getToken(CalculadoraParser.CONTINUE, 0)
    ...
    class BreakStmtContext(InstruccionContext):
        ...
        def BREAK(self):
            return self.getToken(CalculadoraParser.BREAK, 0)
    ...
    class InstruccionDeclaracionContext(InstruccionContext):
        ...
        def declaracion(self):
            return self.getTypedRuleContext(CalculadoraParser.DeclaracionContext,0)
    ...
    class InstruccionFuncionContext(InstruccionContext):
        ...
        def funcionDecl(self):
            return self.getTypedRuleContext(CalculadoraParser.FuncionDeclContext,0)
    ...
    class InstruccionStructContext(InstruccionContext):
        ...
        def structDecl(self):
            return self.getTypedRuleContext(CalculadoraParser.StructDeclContext,0)
    ...
    def instruccion(self):
        ...
        try:
            ...
            if la_ == 1:
                localctx = CalculadoraParser.InstruccionDeclaracionContext(self, localctx)
                self.enterOuterAlt(localctx, 1)
                self.state = 59
                self.declaracion()
                pass
                ...
                localctx = CalculadoraParser.EjecutarAsignacionContext(self, localctx)
                ...
                localctx = CalculadoraParser.EjecutarPrintContext(self, localctx)
                self.enterOuterAlt(localctx, 3)
                self.state = 61
                self.match(CalculadoraParser.PRINTI)
                self.state = 62
                self.match(CalculadoraParser.PARENTESISI)
                self.state = 63
                self.expresion(0)
                self.state = 64
                self.match(CalculadoraParser.PARENTESISD)
                pass

            elif la_ == 4:
                localctx = CalculadoraParser.InstruccionSwitchContext(self, localctx)
                ...
                localctx = CalculadoraParser.InstruccionWhileContext(self, localctx)
                ...
                localctx = CalculadoraParser.InstruccionForContext(self, localctx)
                ...
                localctx = CalculadoraParser.InstruccionReturnContext(self, localctx)
                ...
                localctx = CalculadoraParser.InstruccionFuncionContext(self, localctx)
                ...
                localctx = CalculadoraParser.InstruccionStructContext(self, localctx)
                ...
                localctx = CalculadoraParser.BreakStmtContext(self, localctx)
                self.enterOuterAlt(localctx, 12)
                self.state = 74
                self.match(CalculadoraParser.BREAK)
                pass

            elif la_ == 13:
                localctx = CalculadoraParser.ContinueStmtContext(self, localctx)
                self.enterOuterAlt(localctx, 13)
                self.state = 75
                self.match(CalculadoraParser.CONTINUE)
                pass
    ...
    class DeclaracionContext(ParserRuleContext):
        ...
        def TIPO(self):
            return self.getToken(CalculadoraParser.TIPO, 0)
        ...
        def CORCHI(self, i:int=None):
            if i is None:
                return self.getTokens(CalculadoraParser.CORCHI)
            else:
                return self.getToken(CalculadoraParser.CORCHI, i)

        def CORCHD(self, i:int=None):
            if i is None:
                return self.getTokens(CalculadoraParser.CORCHD)
            else:
                return self.getToken(CalculadoraParser.CORCHD, i)

        def COMA(self, i:int=None):
            if i is None:
                return self.getTokens(CalculadoraParser.COMA)
            else:
                return self.getToken(CalculadoraParser.COMA, i)

        def getRuleIndex(self):
            return CalculadoraParser.RULE_declaracion
    ...
    def declaracion(self):
        ...
        localctx = CalculadoraParser.DeclaracionContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                self.enterOuterAlt(localctx, 1)
                self.state = 79
                self.match(CalculadoraParser.TIPO)
                self.state = 80
                self.match(CalculadoraParser.ID)
                self.state = 83
                self._errHandler.sync(self)
                ...
                self.match(CalculadoraParser.TIPO)
                self.state = 86
                self.match(CalculadoraParser.CORCHI)
                self.state = 87
                self.match(CalculadoraParser.CORCHD)
                self.state = 88
                self.match(CalculadoraParser.ID)
                self.state = 89
                self.match(CalculadoraParser.ASSIGN)
                ...
                while _la==40:
                    self.state = 92
                    self.match(CalculadoraParser.COMA)
                    self.state = 93
                    self.expresion(0)
                    self.state = 98
                    self._errHandler.sync(self)
    ...
    class AsignacionContext(ParserRuleContext):
        ...
        def lvalue(self):
            return self.getTypedRuleContext(CalculadoraParser.LvalueContext,0)
    ...
    class ReturnStmtContext(ParserRuleContext):
        ...
        def RETURN(self):
            return self.getToken(CalculadoraParser.RETURN, 0)
        ...
        def getRuleIndex(self):
            return CalculadoraParser.RULE_returnStmt
    ...
    def returnStmt(self):
        ...
        localctx = CalculadoraParser.ReturnStmtContext(self, self._ctx, self.state)
        self.enterRule(localctx, 10, self.RULE_returnStmt)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 109
            self.match(CalculadoraParser.RETURN)
            self.state = 111
            self._errHandler.sync(self)
    ...
    class FuncionDeclContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return CalculadoraParser.RULE_funcionDecl
    ...
    def funcionDecl(self):
        ...
        localctx = CalculadoraParser.FuncionDeclContext(self, self._ctx, self.state)
    ...
    class ParamsContext(ParserRuleContext):
        ...
        def TIPO(self, i:int=None):
            if i is None:
                return self.getTokens(CalculadoraParser.TIPO)
            else:
                return self.getToken(CalculadoraParser.TIPO, i)
    ...
    class StructDeclContext(ParserRuleContext):
        ...
        def STRUCT(self):
            return self.getToken(CalculadoraParser.STRUCT, 0)

        def ID(self):
            return self.getToken(CalculadoraParser.ID, 0)

        def BLOCKI(self):
            return self.getToken(CalculadoraParser.BLOCKI, 0)

        def BLOCKF(self):
            return self.getToken(CalculadoraParser.BLOCKF, 0)

        def structFieldDecl(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(CalculadoraParser.StructFieldDeclContext)
            else:
                return self.getTypedRuleContext(CalculadoraParser.StructFieldDeclContext,i)


        def getRuleIndex(self):
            return CalculadoraParser.RULE_structDecl
    ...
    def structDecl(self):
        ...
        localctx = CalculadoraParser.StructDeclContext(self, self._ctx, self.state)
        self.enterRule(localctx, 16, self.RULE_structDecl)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 132
            self.match(CalculadoraParser.STRUCT)
            self.state = 133
            self.match(CalculadoraParser.ID)
            self.state = 134
            self.match(CalculadoraParser.BLOCKI)
            self.state = 138
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while _la==3:
            ...
            self.state = 141
            self.match(CalculadoraParser.BLOCKF)
        except RecognitionException as re:
            localctx.exception = re
            self._errHandler.reportError(self, re)
            self._errHandler.recover(self, re)
    ...
    class StructFieldDeclContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return CalculadoraParser.RULE_structFieldDecl
    ...
    def structFieldDecl(self):
        ...
        localctx = CalculadoraParser.StructFieldDeclContext(self, self._ctx, self.state)
    ...
    class WhileStatementContext(ParserRuleContext):
        ...
        def WHILE(self):
            return self.getToken(CalculadoraParser.WHILE, 0)
        ...
        def getRuleIndex(self):
            return CalculadoraParser.RULE_whileStatement
    ...
    def whileStatement(self):
        ...
        localctx = CalculadoraParser.WhileStatementContext(self, self._ctx, self.state)
        self.enterRule(localctx, 20, self.RULE_whileStatement)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 146
            self.match(CalculadoraParser.WHILE)
            self.state = 147
            self.match(CalculadoraParser.PARENTESISI)
            self.state = 148
            self.expresion(0)
    ...
    class ForStatementContext(ParserRuleContext):
        ...
        def FOR(self):
            return self.getToken(CalculadoraParser.FOR, 0)
        ...
        def asignacion(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(CalculadoraParser.AsignacionContext)
            else:
                return self.getTypedRuleContext(CalculadoraParser.AsignacionContext,i)
        ...
        def getRuleIndex(self):
            return CalculadoraParser.RULE_forStatement
    ...
    def forStatement(self):
        ...
        localctx = CalculadoraParser.ForStatementContext(self, self._ctx, self.state)
        self.enterRule(localctx, 22, self.RULE_forStatement)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 152
            self.match(CalculadoraParser.FOR)
            self.state = 153
            self.match(CalculadoraParser.PARENTESISI)
            self.state = 154
            self.asignacion()
    ...
    class IfStatementContext(ParserRuleContext):
        ...
        def IFINICIO(self):
            return self.getToken(CalculadoraParser.IFINICIO, 0)
        ...
        def ELSE(self):
            return self.getToken(CalculadoraParser.ELSE, 0)
    ...
    def ifStatement(self):
        ...
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 171
            self.match(CalculadoraParser.IFINICIO)
            self.state = 172
            self.match(CalculadoraParser.PARENTESISI)
            self.state = 173
            self.expresion(0)
            ...
            if _la==10:
                self.state = 176
                self.match(CalculadoraParser.ELSE)
                self.state = 177
                self.block()
    ...
    class SwitchStatementContext(ParserRuleContext):
        ...
        def SWITCH(self):
            return self.getToken(CalculadoraParser.SWITCH, 0)
        ...
        def caseClause(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(CalculadoraParser.CaseClauseContext)
            else:
                return self.getTypedRuleContext(CalculadoraParser.CaseClauseContext,i)


        def defaultClause(self):
            return self.getTypedRuleContext(CalculadoraParser.DefaultClauseContext,0)


        def getRuleIndex(self):
            return CalculadoraParser.RULE_switchStatement
    ...
    def switchStatement(self):
        ...
        localctx = CalculadoraParser.SwitchStatementContext(self, self._ctx, self.state)
        self.enterRule(localctx, 28, self.RULE_switchStatement)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 180
            self.match(CalculadoraParser.SWITCH)
            self.state = 181
            self.match(CalculadoraParser.PARENTESISI)
            self.state = 182
            self.expresion(0)
    ...
    class CaseClauseContext(ParserRuleContext):
        ...
        def CASE(self):
            return self.getToken(CalculadoraParser.CASE, 0)
        ...
        def COLON(self):
            return self.getToken(CalculadoraParser.COLON, 0)
        ...
        def getRuleIndex(self):
            return CalculadoraParser.RULE_caseClause
    ...
    def caseClause(self):
        ...
        localctx = CalculadoraParser.CaseClauseContext(self, self._ctx, self.state)
        self.enterRule(localctx, 30, self.RULE_caseClause)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 195
            self.match(CalculadoraParser.CASE)
            self.state = 196
            self.expresion(0)
            self.state = 197
            self.match(CalculadoraParser.COLON)
            self.state = 201
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while (((_la) & ~0x3f) == 0 and ((1 << _la) & 193514103098056) != 0):
    ...
    class DefaultClauseContext(ParserRuleContext):
        ...
        def DEFAULT(self):
            return self.getToken(CalculadoraParser.DEFAULT, 0)
        ...
        def getRuleIndex(self):
            return CalculadoraParser.RULE_defaultClause
    ...
    def defaultClause(self):
        ...
        localctx = CalculadoraParser.DefaultClauseContext(self, self._ctx, self.state)
        self.enterRule(localctx, 32, self.RULE_defaultClause)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 204
            self.match(CalculadoraParser.DEFAULT)
            self.state = 205
            self.match(CalculadoraParser.COLON)
            self.state = 209
            self._errHandler.sync(self)
    ...
    class LvalueContext(ParserRuleContext):
        ...
        def PUNTO(self, i:int=None):
            if i is None:
                return self.getTokens(CalculadoraParser.PUNTO)
            else:
                return self.getToken(CalculadoraParser.PUNTO, i)
        ...
        def getRuleIndex(self):
            return CalculadoraParser.RULE_lvalue
    ...
    def lvalue(self):
        ...
        localctx = CalculadoraParser.LvalueContext(self, self._ctx, self.state)
        ...
        try:
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    ...
                    if token in [41]:
                        self.state = 213
                        self.match(CalculadoraParser.PUNTO)
                        self.state = 214
                        self.match(CalculadoraParser.ID)
                        pass
                    elif token in [22]:
    ...
    class CorchetesContext(ExpresionContext):
        ...
        def CORCHI(self):
            return self.getToken(CalculadoraParser.CORCHI, 0)
        def expresion(self):
            return self.getTypedRuleContext(CalculadoraParser.ExpresionContext,0)

        def CORCHD(self):
            return self.getToken(CalculadoraParser.CORCHD, 0)
    ...
    class NotLogicoContext(ExpresionContext):
        ...
        def NOTLOGICO(self):
            return self.getToken(CalculadoraParser.NOTLOGICO, 0)
        def expresion(self):
            return self.getTypedRuleContext(CalculadoraParser.ExpresionContext,0)
    ...
    class BooleanoContext(ExpresionContext):
        ...
        def BOOLEANO(self):
            return self.getToken(CalculadoraParser.BOOLEANO, 0)
    ...
    class SumaRestaContext(ExpresionContext):
        ...
        def SUM(self):
            return self.getToken(CalculadoraParser.SUM, 0)
        def REST(self):
            return self.getToken(CalculadoraParser.REST, 0)
    ...
    class AndOrLogicoContext(ExpresionContext):
        ...
        def AND(self):
            return self.getToken(CalculadoraParser.AND, 0)
        def OR(self):
            return self.getToken(CalculadoraParser.OR, 0)
    ...
    class RelacionalContext(ExpresionContext):
        ...
        def IGUALA(self):
            return self.getToken(CalculadoraParser.IGUALA, 0)
        def DIFERENTEA(self):
            return self.getToken(CalculadoraParser.DIFERENTEA, 0)
        def DIFERENTEA2(self):
            return self.getToken(CalculadoraParser.DIFERENTEA2, 0)
        def MENORQUE(self):
            return self.getToken(CalculadoraParser.MENORQUE, 0)
        def MAYORQUE(self):
            return self.getToken(CalculadoraParser.MAYORQUE, 0)
        def MENORIGUAL(self):
            return self.getToken(CalculadoraParser.MENORIGUAL, 0)
        def MAYORIGUAL(self):
            return self.getToken(CalculadoraParser.MAYORIGUAL, 0)
    ...
    class TernarioContext(ExpresionContext):
        ...
        def QUESTION(self):
            return self.getToken(CalculadoraParser.QUESTION, 0)
        def COLON(self):
            return self.getToken(CalculadoraParser.COLON, 0)
    ...
    class LlamadaModuloContext(ExpresionContext):
        ...
        def ID(self, i:int=None):
            if i is None:
                ...
                return self.getToken(CalculadoraParser.ID, i)
        def PUNTO(self):
            return self.getToken(CalculadoraParser.PUNTO, 0)
        def PARENTESISI(self):
            return self.getToken(CalculadoraParser.PARENTESISI, 0)
        def PARENTESISD(self):
            return self.getToken(CalculadoraParser.PARENTESISD, 0)
    ...
    def expresion(self, _p:int=0):
        ...
        try:
            ...
            if la_ == 1:
                localctx = CalculadoraParser.CastExplicitoContext(self, localctx)
                self._ctx = localctx
                _prevctx = localctx
                ...
                localctx = CalculadoraParser.CorchetesContext(self, localctx)
                self._ctx = localctx
                _prevctx = localctx
                self.state = 233
                self.match(CalculadoraParser.CORCHI)
                ...
                localctx = CalculadoraParser.BooleanoContext(self, localctx)
                self._ctx = localctx
                _prevctx = localctx
                self.state = 239
                self.match(CalculadoraParser.BOOLEANO)
                pass
                ...
                localctx = CalculadoraParser.LlamadaModuloContext(self, localctx)
                self._ctx = localctx
                _prevctx = localctx
                self.state = 246
                self.match(CalculadoraParser.ID)
                ...
                _prevctx = localctx
                self.state = 262
                self.match(CalculadoraParser.NOTLOGICO)
                self.state = 263
                self.expresion(6)
                pass
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    ...
                    if la_ == 1:
                        localctx = CalculadoraParser.MultiplicacionDivisisionModContext(self, CalculadoraParser.ExpresionContext(self, _parentctx, _parentState))
                        ...
                        localctx = CalculadoraParser.TernarioContext(self, CalculadoraParser.ExpresionContext(self, _parentctx, _parentState))
                        self.pushNewRecursionContext(localctx, _startState, self.RULE_expresion)
                        self.state = 278
                        ...
                        self.state = 279
                        self.match(CalculadoraParser.QUESTION)
                        self.state = 280
                        self.expresion(0)
                        self.state = 281
                        self.match(CalculadoraParser.COLON)
