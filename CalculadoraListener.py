...
class CalculadoraListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by CalculadoraParser#Relacional.
    def enterRelacional(self, ctx:CalculadoraParser.RelacionalContext):
        pass

    # Exit a parse tree produced by CalculadoraParser#Relacional.
    def exitRelacional(self, ctx:CalculadoraParser.RelacionalContext):
        pass
